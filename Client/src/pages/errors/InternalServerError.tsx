...
const InternalServerError = () => {
  return (
    <section className="flex justify-center items-center flex-col h-full flex-grow w-full gap-4">
      <h1 className="text-primary text-2xl font-extrabold">Internal Server Error 500</h1>
      <h2 className="text-primary text-lg font-bold">Something went wrong on our end.</h2>
