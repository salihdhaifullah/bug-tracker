...
const NotFound = () => {
  return (
    <section className="flex justify-center items-center flex-col h-full flex-grow w-full gap-4">
      <h1 className="text-primary dark:text-secondary  text-2xl font-extrabold">Not Found 404</h1>
      <h2 className="text-primary dark:text-secondary  text-lg font-bold">The page you requested could not be found.</h2>
