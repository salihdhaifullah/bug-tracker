...
const Unauthorized = () => {
  return (
    <section className="flex justify-center items-center flex-col h-full flex-grow w-full gap-4">
      <h1 className="text-primary text-2xl font-extrabold">Unauthorized 401</h1>
      <h2 className="text-primary text-lg font-bold">You are not authorized to access this page.</h2>
