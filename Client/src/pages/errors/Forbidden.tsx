...
const Forbidden = () => {
  return (
    <section className="flex justify-center items-center flex-col h-full flex-grow w-full gap-4">
      <h1 className="text-primary dark:text-secondary text-2xl font-extrabold">Forbidden 403</h1>
      <h2 className="text-primary dark:text-secondary text-lg font-bold">You do not have permission to do this action</h2>
