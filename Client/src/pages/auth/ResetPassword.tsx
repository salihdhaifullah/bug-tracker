    ...
    return (
        <section className="flex flex-col justify-center items-center flex-grow">
            <div className="rounded-xl bg-white flex flex-col gap-4 w-80 p-2 items-center justify-center shadow-xl">
                ...
                <form className="flex-col flex w-full justify-center items-center" action="/auth/reset-password" method="post">
                    ...
                    <div className="flex flex-col justify-center items-center p-2 px-6 w-full gap-2">
                        <div className="flex flex-row gap-2  w-full justify-center items-center relative">
                            <label className="text-base absolute bottom-[20%] left-[20%] font-extralight text-gray-600 transition-all ease-in-out" htmlFor="NewPassword">New Password</label>
                            <i className="fa-solid fa-key text-gray-600 text-base"></i>
                            <input className="p-2 border border-gray-400 h-fit hover:border-gray-900 focus:outline-secondary rounded-sm w-full" type="text" id="NewPassword" value="@Model.NewPassword" name="NewPassword" />
                        </div>
                    </div>
