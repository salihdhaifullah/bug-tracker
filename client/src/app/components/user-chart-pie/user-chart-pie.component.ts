...
@Component({
  selector: 'app-user-chart-pie',
  templateUrl: './user-chart-pie.component.html'
})
export class UserChartPieComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.ticketsService.GetUserPieChartData().subscribe(data => {
      this.tickets = data
      this.isLoading = true;
    }, err => { }, () => {
